#ifndef PBDETECTOR_CUDA_H
#define PBDETECTOR_CUDA_H
 ...
 */
class PbDetector_CUDA
{   
public:
    PbDetector_CUDA(int scale, const cv::Mat& image);
...
private:
	...
	bool initializeGPUMemory(cv::Mat mat);
...
private:
	...
	//CUDA
	 Matrix_CUDA m_Image_CUDA;
	 Matrix_CUDA* m_Gradient_CUDA;
	 HistoVect_CUDA m_ImageHistograms;
